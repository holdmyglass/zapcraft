...
class ZapCraftInterfaceCommand extends Command
{
    use ZapCraftCommandHelpertraits;

    protected $signature = 'zapcraft:interface {entity} {--module=}';

    public $description = 'Generate interfaces for the entity repository';
